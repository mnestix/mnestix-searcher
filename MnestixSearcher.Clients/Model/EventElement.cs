...
namespace MnestixSearcher.Clients.Model
{
    ...
    /// EventElement
    /// </summary>
    public partial class EventElement : IValidatableObject
    {
        /// <summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="EventElement" />
    /// </summary>
    public class EventElementJsonConverter : JsonConverter<EventElement>
    {
        /// <summary>
        /// Deserializes json to <see cref="EventElement" />
        /// </summary>
        ...
        public override EventElement Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (embeddedDataSpecifications.IsSet && embeddedDataSpecifications.Value == null)
                throw new ArgumentNullException(nameof(embeddedDataSpecifications), "Property is not nullable for class EventElement.");

            if (displayName.IsSet && displayName.Value == null)
                throw new ArgumentNullException(nameof(displayName), "Property is not nullable for class EventElement.");

            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class EventElement.");

            if (category.IsSet && category.Value == null)
                throw new ArgumentNullException(nameof(category), "Property is not nullable for class EventElement.");

            if (idShort.IsSet && idShort.Value == null)
                throw new ArgumentNullException(nameof(idShort), "Property is not nullable for class EventElement.");

            if (extensions.IsSet && extensions.Value == null)
                throw new ArgumentNullException(nameof(extensions), "Property is not nullable for class EventElement.");

            if (semanticId.IsSet && semanticId.Value == null)
                throw new ArgumentNullException(nameof(semanticId), "Property is not nullable for class EventElement.");

            if (supplementalSemanticIds.IsSet && supplementalSemanticIds.Value == null)
                throw new ArgumentNullException(nameof(supplementalSemanticIds), "Property is not nullable for class EventElement.");

            if (qualifiers.IsSet && qualifiers.Value == null)
                throw new ArgumentNullException(nameof(qualifiers), "Property is not nullable for class EventElement.");

            return new EventElement(embeddedDataSpecifications, displayName, description, category, idShort, extensions, semanticId, supplementalSemanticIds, qualifiers);
        }

        /// <summary>
        /// Serializes a <see cref="EventElement" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="eventElement"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EventElement eventElement, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, eventElement, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EventElement" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="eventElement"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EventElement eventElement, JsonSerializerOptions jsonSerializerOptions)
        {
            if (eventElement.EmbeddedDataSpecificationsOption.IsSet && eventElement.EmbeddedDataSpecifications == null)
                throw new ArgumentNullException(nameof(eventElement.EmbeddedDataSpecifications), "Property is required for class EventElement.");

            if (eventElement.DisplayNameOption.IsSet && eventElement.DisplayName == null)
                throw new ArgumentNullException(nameof(eventElement.DisplayName), "Property is required for class EventElement.");

            if (eventElement.DescriptionOption.IsSet && eventElement.Description == null)
                throw new ArgumentNullException(nameof(eventElement.Description), "Property is required for class EventElement.");

            if (eventElement.CategoryOption.IsSet && eventElement.Category == null)
                throw new ArgumentNullException(nameof(eventElement.Category), "Property is required for class EventElement.");

            if (eventElement.IdShortOption.IsSet && eventElement.IdShort == null)
                throw new ArgumentNullException(nameof(eventElement.IdShort), "Property is required for class EventElement.");

            if (eventElement.ExtensionsOption.IsSet && eventElement.Extensions == null)
                throw new ArgumentNullException(nameof(eventElement.Extensions), "Property is required for class EventElement.");

            if (eventElement.SemanticIdOption.IsSet && eventElement.SemanticId == null)
                throw new ArgumentNullException(nameof(eventElement.SemanticId), "Property is required for class EventElement.");

            if (eventElement.SupplementalSemanticIdsOption.IsSet && eventElement.SupplementalSemanticIds == null)
                throw new ArgumentNullException(nameof(eventElement.SupplementalSemanticIds), "Property is required for class EventElement.");

            if (eventElement.QualifiersOption.IsSet && eventElement.Qualifiers == null)
                throw new ArgumentNullException(nameof(eventElement.Qualifiers), "Property is required for class EventElement.");

            if (eventElement.EmbeddedDataSpecificationsOption.IsSet)
            {
                writer.WritePropertyName("embeddedDataSpecifications");
                JsonSerializer.Serialize(writer, eventElement.EmbeddedDataSpecifications, jsonSerializerOptions);
            }
            if (eventElement.DisplayNameOption.IsSet)
            {
                writer.WritePropertyName("displayName");
                JsonSerializer.Serialize(writer, eventElement.DisplayName, jsonSerializerOptions);
            }
            if (eventElement.DescriptionOption.IsSet)
            {
                writer.WritePropertyName("description");
                JsonSerializer.Serialize(writer, eventElement.Description, jsonSerializerOptions);
            }
            if (eventElement.CategoryOption.IsSet)
                writer.WriteString("category", eventElement.Category);

            if (eventElement.IdShortOption.IsSet)
                writer.WriteString("idShort", eventElement.IdShort);

            if (eventElement.ExtensionsOption.IsSet)
            {
                writer.WritePropertyName("extensions");
                JsonSerializer.Serialize(writer, eventElement.Extensions, jsonSerializerOptions);
            }
            if (eventElement.SemanticIdOption.IsSet)
            {
                writer.WritePropertyName("semanticId");
                JsonSerializer.Serialize(writer, eventElement.SemanticId, jsonSerializerOptions);
            }
            if (eventElement.SupplementalSemanticIdsOption.IsSet)
            {
                writer.WritePropertyName("supplementalSemanticIds");
                JsonSerializer.Serialize(writer, eventElement.SupplementalSemanticIds, jsonSerializerOptions);
            }
            if (eventElement.QualifiersOption.IsSet)
            {
                writer.WritePropertyName("qualifiers");
                JsonSerializer.Serialize(writer, eventElement.Qualifiers, jsonSerializerOptions);
            }
        }
    }
}
