...
{
    /// <summary>
    /// EntityAllOfStatements
    /// </summary>
    public partial class EntityAllOfStatements : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EntityAllOfStatements" /> class.
        /// </summary>
        /// <param name="capability"></param>
        public EntityAllOfStatements(Capability capability)
        {
        ...
        public EntityAllOfStatements(Entity entity)
        {
            Entity = entity;
            OnCreated();
        }
        ...
        public EntityAllOfStatements(EventElement eventElement)
        {
        ...
        public EntityAllOfStatements(Operation operation)
        {
            Operation = operation;
            OnCreated();
        }
        ...
        public EntityAllOfStatements(RelationshipElement relationshipElement)
        {
        ...
        public EntityAllOfStatements(SubmodelElementCollection submodelElementCollection)
        {
        ...
        public EntityAllOfStatements(SubmodelElementList submodelElementList)
        {
        ...
        public EntityAllOfStatements(BasicEventElement basicEventElement)
        {
        ...
        public EntityAllOfStatements(AnnotatedRelationshipElement annotatedRelationshipElement)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EntityAllOfStatements {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="EntityAllOfStatements" />
    /// </summary>
    public class EntityAllOfStatementsJsonConverter : JsonConverter<EntityAllOfStatements>
    {
        /// <summary>
        /// Deserializes json to <see cref="EntityAllOfStatements" />
        /// </summary>
        ...
        public override EntityAllOfStatements Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (capability != null)
                return new EntityAllOfStatements(capability);

            if (entity != null)
                return new EntityAllOfStatements(entity);

            if (eventElement != null)
                return new EntityAllOfStatements(eventElement);

            if (operation != null)
                return new EntityAllOfStatements(operation);

            if (relationshipElement != null)
                return new EntityAllOfStatements(relationshipElement);

            if (submodelElementCollection != null)
                return new EntityAllOfStatements(submodelElementCollection);

            if (submodelElementList != null)
                return new EntityAllOfStatements(submodelElementList);

            if (basicEventElement != null)
                return new EntityAllOfStatements(basicEventElement);

            if (annotatedRelationshipElement != null)
                return new EntityAllOfStatements(annotatedRelationshipElement);

            throw new JsonException();
        }

        /// <summary>
        /// Serializes a <see cref="EntityAllOfStatements" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="entityAllOfStatements"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EntityAllOfStatements entityAllOfStatements, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, entityAllOfStatements, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EntityAllOfStatements" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="entityAllOfStatements"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EntityAllOfStatements entityAllOfStatements, JsonSerializerOptions jsonSerializerOptions)
        {
