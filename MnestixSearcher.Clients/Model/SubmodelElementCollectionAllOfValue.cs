...
{
    /// <summary>
    /// SubmodelElementCollectionAllOfValue
    /// </summary>
    public partial class SubmodelElementCollectionAllOfValue : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubmodelElementCollectionAllOfValue" /> class.
        /// </summary>
        /// <param name="capability"></param>
        public SubmodelElementCollectionAllOfValue(Capability capability)
        {
        ...
        public SubmodelElementCollectionAllOfValue(Entity entity)
        {
            Entity = entity;
            OnCreated();
        }
        ...
        public SubmodelElementCollectionAllOfValue(EventElement eventElement)
        {
        ...
        public SubmodelElementCollectionAllOfValue(Operation operation)
        {
            Operation = operation;
            OnCreated();
        }
        ...
        public SubmodelElementCollectionAllOfValue(RelationshipElement relationshipElement)
        {
        ...
        public SubmodelElementCollectionAllOfValue(SubmodelElementCollection submodelElementCollection)
        {
        ...
        public SubmodelElementCollectionAllOfValue(SubmodelElementList submodelElementList)
        {
        ...
        public SubmodelElementCollectionAllOfValue(BasicEventElement basicEventElement)
        {
        ...
        public SubmodelElementCollectionAllOfValue(AnnotatedRelationshipElement annotatedRelationshipElement)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SubmodelElementCollectionAllOfValue {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="SubmodelElementCollectionAllOfValue" />
    /// </summary>
    public class SubmodelElementCollectionAllOfValueJsonConverter : JsonConverter<SubmodelElementCollectionAllOfValue>
    {
        /// <summary>
        /// Deserializes json to <see cref="SubmodelElementCollectionAllOfValue" />
        /// </summary>
        ...
        public override SubmodelElementCollectionAllOfValue Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (capability != null)
                return new SubmodelElementCollectionAllOfValue(capability);

            if (entity != null)
                return new SubmodelElementCollectionAllOfValue(entity);

            if (eventElement != null)
                return new SubmodelElementCollectionAllOfValue(eventElement);

            if (operation != null)
                return new SubmodelElementCollectionAllOfValue(operation);

            if (relationshipElement != null)
                return new SubmodelElementCollectionAllOfValue(relationshipElement);

            if (submodelElementCollection != null)
                return new SubmodelElementCollectionAllOfValue(submodelElementCollection);

            if (submodelElementList != null)
                return new SubmodelElementCollectionAllOfValue(submodelElementList);

            if (basicEventElement != null)
                return new SubmodelElementCollectionAllOfValue(basicEventElement);

            if (annotatedRelationshipElement != null)
                return new SubmodelElementCollectionAllOfValue(annotatedRelationshipElement);

            throw new JsonException();
        }

        /// <summary>
        /// Serializes a <see cref="SubmodelElementCollectionAllOfValue" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="submodelElementCollectionAllOfValue"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, SubmodelElementCollectionAllOfValue submodelElementCollectionAllOfValue, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, submodelElementCollectionAllOfValue, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="SubmodelElementCollectionAllOfValue" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="submodelElementCollectionAllOfValue"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, SubmodelElementCollectionAllOfValue submodelElementCollectionAllOfValue, JsonSerializerOptions jsonSerializerOptions)
        {
