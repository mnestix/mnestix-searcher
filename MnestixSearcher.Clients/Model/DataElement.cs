...
namespace MnestixSearcher.Clients.Model
{
    ...
    /// DataElement
    /// </summary>
    public partial class DataElement : IValidatableObject
    {
        /// <summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="DataElement" />
    /// </summary>
    public class DataElementJsonConverter : JsonConverter<DataElement>
    {
        /// <summary>
        /// Deserializes json to <see cref="DataElement" />
        /// </summary>
        ...
        public override DataElement Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (embeddedDataSpecifications.IsSet && embeddedDataSpecifications.Value == null)
                throw new ArgumentNullException(nameof(embeddedDataSpecifications), "Property is not nullable for class DataElement.");

            if (displayName.IsSet && displayName.Value == null)
                throw new ArgumentNullException(nameof(displayName), "Property is not nullable for class DataElement.");

            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class DataElement.");

            if (category.IsSet && category.Value == null)
                throw new ArgumentNullException(nameof(category), "Property is not nullable for class DataElement.");

            if (idShort.IsSet && idShort.Value == null)
                throw new ArgumentNullException(nameof(idShort), "Property is not nullable for class DataElement.");

            if (extensions.IsSet && extensions.Value == null)
                throw new ArgumentNullException(nameof(extensions), "Property is not nullable for class DataElement.");

            if (semanticId.IsSet && semanticId.Value == null)
                throw new ArgumentNullException(nameof(semanticId), "Property is not nullable for class DataElement.");

            if (supplementalSemanticIds.IsSet && supplementalSemanticIds.Value == null)
                throw new ArgumentNullException(nameof(supplementalSemanticIds), "Property is not nullable for class DataElement.");

            if (qualifiers.IsSet && qualifiers.Value == null)
                throw new ArgumentNullException(nameof(qualifiers), "Property is not nullable for class DataElement.");

            return new DataElement(embeddedDataSpecifications, displayName, description, category, idShort, extensions, semanticId, supplementalSemanticIds, qualifiers);
        }

        /// <summary>
        /// Serializes a <see cref="DataElement" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="dataElement"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, DataElement dataElement, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, dataElement, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="DataElement" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="dataElement"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, DataElement dataElement, JsonSerializerOptions jsonSerializerOptions)
        {
            if (dataElement.EmbeddedDataSpecificationsOption.IsSet && dataElement.EmbeddedDataSpecifications == null)
                throw new ArgumentNullException(nameof(dataElement.EmbeddedDataSpecifications), "Property is required for class DataElement.");

            if (dataElement.DisplayNameOption.IsSet && dataElement.DisplayName == null)
                throw new ArgumentNullException(nameof(dataElement.DisplayName), "Property is required for class DataElement.");

            if (dataElement.DescriptionOption.IsSet && dataElement.Description == null)
                throw new ArgumentNullException(nameof(dataElement.Description), "Property is required for class DataElement.");

            if (dataElement.CategoryOption.IsSet && dataElement.Category == null)
                throw new ArgumentNullException(nameof(dataElement.Category), "Property is required for class DataElement.");

            if (dataElement.IdShortOption.IsSet && dataElement.IdShort == null)
                throw new ArgumentNullException(nameof(dataElement.IdShort), "Property is required for class DataElement.");

            if (dataElement.ExtensionsOption.IsSet && dataElement.Extensions == null)
                throw new ArgumentNullException(nameof(dataElement.Extensions), "Property is required for class DataElement.");

            if (dataElement.SemanticIdOption.IsSet && dataElement.SemanticId == null)
                throw new ArgumentNullException(nameof(dataElement.SemanticId), "Property is required for class DataElement.");

            if (dataElement.SupplementalSemanticIdsOption.IsSet && dataElement.SupplementalSemanticIds == null)
                throw new ArgumentNullException(nameof(dataElement.SupplementalSemanticIds), "Property is required for class DataElement.");

            if (dataElement.QualifiersOption.IsSet && dataElement.Qualifiers == null)
                throw new ArgumentNullException(nameof(dataElement.Qualifiers), "Property is required for class DataElement.");

            if (dataElement.EmbeddedDataSpecificationsOption.IsSet)
            {
                writer.WritePropertyName("embeddedDataSpecifications");
                JsonSerializer.Serialize(writer, dataElement.EmbeddedDataSpecifications, jsonSerializerOptions);
            }
            if (dataElement.DisplayNameOption.IsSet)
            {
                writer.WritePropertyName("displayName");
                JsonSerializer.Serialize(writer, dataElement.DisplayName, jsonSerializerOptions);
            }
            if (dataElement.DescriptionOption.IsSet)
            {
                writer.WritePropertyName("description");
                JsonSerializer.Serialize(writer, dataElement.Description, jsonSerializerOptions);
            }
            if (dataElement.CategoryOption.IsSet)
                writer.WriteString("category", dataElement.Category);

            if (dataElement.IdShortOption.IsSet)
                writer.WriteString("idShort", dataElement.IdShort);

            if (dataElement.ExtensionsOption.IsSet)
            {
                writer.WritePropertyName("extensions");
                JsonSerializer.Serialize(writer, dataElement.Extensions, jsonSerializerOptions);
            }
            if (dataElement.SemanticIdOption.IsSet)
            {
                writer.WritePropertyName("semanticId");
                JsonSerializer.Serialize(writer, dataElement.SemanticId, jsonSerializerOptions);
            }
            if (dataElement.SupplementalSemanticIdsOption.IsSet)
            {
                writer.WritePropertyName("supplementalSemanticIds");
                JsonSerializer.Serialize(writer, dataElement.SupplementalSemanticIds, jsonSerializerOptions);
            }
            if (dataElement.QualifiersOption.IsSet)
            {
                writer.WritePropertyName("qualifiers");
                JsonSerializer.Serialize(writer, dataElement.Qualifiers, jsonSerializerOptions);
            }
        }
    }
}
